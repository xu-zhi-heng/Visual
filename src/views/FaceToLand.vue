    ...
    <div id="faceToLand">
        <div class="header">
            <div class="header-container">
                <div class="header-title">人脸登陆</div>
                ...
                tracker.on('track', function(event) {
                    ...
                    if (event.data.length) {
                        ...
                        if (flag) {
                            ...
                            user.loginByFace(_this.faceImg).then(res => {
                                if(res.code == 1) {
                                    removeToken()
                                    ...
                                    _this.$message({message: "登陆失败",type: 'error'})
                                }
                            }).catch(err => {
                                this.getCompetence()
                                console.log(err)
                            ...
                            // 生成人脸令牌
                            // user.createFaceToken({image: _this.faceImg.image,user_id: '64dc146e-a423-567e-b70f-4b6ad5cd6f48'}).then(res => {
                            //     console.log(res)
                            // }).catch(err => {
                            //     console.log(err)
                            // })
