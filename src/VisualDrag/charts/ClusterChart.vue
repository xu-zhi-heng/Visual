<template>
    <div class="datav-wrapper" :style="getWidthAndHeightAndOpacity()">
        <div class="clusterChart" ref="clusterChart">
    ...
    export default {
        ...
        methods: {
            init(type) {
                ...
                this.clusterChartDom = this.$echarts.init(this.$refs.clusterChart)
                if(type == 0) {
                    this.clusterChartDom.setOption(this.clusterChartData,true)
                    this.$set(this.data,'options',this.clusterChartData)
                    this.$set(this.data,'echartInstance',this.clusterChartDom)
                }else if (type == 1){
